...
class PluginProvider
{
    ...
    private static $ARR_PLUGIN_CONFIG =
        array(
            ...
            "char_counter" => [
                PluginProvider::KEY_CSS => 1,
                PluginProvider::KEY_FOLDER => PluginProvider::VALUE_PLUGINS
            ],
            "code_beautifier" => [
                PluginProvider::KEY_CSS => 0,
                PluginProvider::KEY_FOLDER => PluginProvider::VALUE_PLUGINS
            ],
            ...
            "embedly" => [
                PluginProvider::KEY_CSS => 1,
                PluginProvider::KEY_FOLDER => PluginProvider::VALUE_THIRD_PARTY
            ],
            "spell_checker" => [
                PluginProvider::KEY_CSS => 1,
                PluginProvider::KEY_FOLDER => PluginProvider::VALUE_THIRD_PARTY
