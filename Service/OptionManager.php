...
class OptionManager
{
    ...
    private function addImageCustomParams(array &$p_arrOption)
    {
        ...
        $arrCustomParams =
            array(
                "folder" => $p_arrOption["imageUploadFolder"],
                "path" => $p_arrOption["imageUploadPath"],
                "public_dir" => $p_arrOption["publicDir"]
            );
        //------------------------- DECLARE ---------------------------//
    ...
    private function addFileCustomParams(array &$p_arrOption)
    {
        ...
        $arrCustomParams =
            array(
                "folder" => $p_arrOption["fileUploadFolder"],
                "path" => $p_arrOption["fileUploadPath"],
                "public_dir" => $p_arrOption["publicDir"]
            );
        //------------------------- DECLARE ---------------------------//
    ...
    private function addVideoCustomParams(array &$p_arrOption)
    {
        ...
        $arrCustomParams =
            array(
                "folder" => $p_arrOption["videoUploadFolder"],
                "path" => $p_arrOption["videoUploadPath"],
                "public_dir" => $p_arrOption["publicDir"]
            );
        //------------------------- DECLARE ---------------------------//
